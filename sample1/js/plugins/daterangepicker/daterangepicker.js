...
!function ($) {
    ...
    var DateRangePicker = function (element, options, cb) {
                ...
                '<div class="ranges">' +
                  '<div class="range_inputs">' +
                    '<div class="daterangepicker_start_input" style="float: left">' +
                      ...
                      '<input class="form-control global" type="text" name="daterangepicker_start" value="" disabled="disabled" />' +
                    '</div>' +
                    '<div class="daterangepicker_end_input" style="float: left;">' +
                      '<label for="daterangepicker_end">' + this.locale.toLabel + '</label>' +
                      '<input class="form-control global" type="text" name="daterangepicker_end" value="" disabled="disabled" />' +
                    '</div>' +
        ...
        this.container.addClass('opens' + this.opens + ' override');
    ...
    DateRangePicker.prototype = {
        ...
        show: function (e) {
        	this.parentEl.addClass('openCalendar');
            this.container.show();
            this.move();
        ...
        hide: function (e) {
        	this.parentEl.removeClass('openCalendar');
            this.container.hide();
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate) {
            ...
            if (this.timePicker) {
                ...
                html += '<div class="calendar-time form-inline">';
                html += '<div class="form-group row-visible-xs">';
                html += '<div class="col-md-4">';
                html += '<select class="hourselect form-control global">';
                var start = 0;
                var end = 23;
                ...
                html += '</select><span class="fa fa-angle-down form-control-feedback visible-xs"></span></div></div>';

                html += '<div class="form-group row-visible-xs">';
                html += '<div class="col-md-4">';
                html += '<select class="minuteselect form-control global">';
                ...
                html += '</select><span class="fa fa-angle-down form-control-feedback visible-xs"></div></div>';

                if (this.timePicker12Hour) {
                	html += '<div class="form-group row-visible-xs">';
                	html += '<div class="col-md-4">';
                    html += '<select class="ampmselect form-control global">';
                    if (selected.hour() >= 12) {
